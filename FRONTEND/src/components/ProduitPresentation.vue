      ...
      <div class="md:mb-10 lg:mb-20 -mt-4 md:mt-10 lg:mt-20 w-full md:w-1/2 lg:h-[45rem] bg-zinc-800 mb-10">
          <div class="">
              ...
              <div class="flex align-items mt-10 pl-5 md:pl-10 lg:pl-20 xl:pl-32 2xl:pl-60 mb-2">
                  ...
                  <button>
                    <h1 class="text-lg pl-2 font-light uppercase text-tem-yellow"><a href="https://drdh.fr/letem54/cartes-menu-restaurant-le-TEM" data-replace="Nos Cartes & Menus"><span>Nos Cartes & Menus</span></a></h1>
                  </button>
              </div>
          </div>
      </div>
