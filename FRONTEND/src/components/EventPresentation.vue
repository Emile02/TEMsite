<template>
  <div class="mb-5 md:mb-10 lg:mb-20">
        ...
        <h2 class="flex justify-center mt-4 text-xl font-thin uppercase text-yellow-800 md:text-2xl lg:text-3xl md:mt-6 lg:mt-10 mb-10 text-center" style="transition:all 1s ease-in-out">Un lieu au multiples évènements (Trouver un texte pour remplacer celui ci-dessous)</h2>
        ...
        <button class="w-48">
            <h1 class="text-lg -ml-4 font-light uppercase text-tem-yellow"><a data-replace="Réserver une table" class="event mt-2 text-lg font-light uppercase"><span>Réserver une table</span></a></h1>
        </button>
        </div>
